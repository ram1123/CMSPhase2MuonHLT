...
"""
    ...
    from HLTrigger.PhaseII.Muon.Customizers.customizerForPhase2MuonHLT_AP import customizePhase2MuonHLTReconstruction
    process = customizePhase2MuonHLTReconstruction(process)

    from HLTrigger.PhaseII.Muon.Customizers.customizerForPhase2MuonHLT_AP import customizePhase2MuonHLTIsolation
