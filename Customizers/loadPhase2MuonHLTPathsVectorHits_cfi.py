...
"""
    ...
    from HLTrigger.PhaseII.Muon.Customizers.customizerForPhase2MuonHLTVectorHits import customizePhase2MuonHLTReconstruction
    process = customizePhase2MuonHLTReconstruction(process)

    from HLTrigger.PhaseII.Muon.Customizers.customizerForPhase2MuonHLTVectorHits import customizePhase2MuonHLTIsolation
