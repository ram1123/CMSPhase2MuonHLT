...
"""
    ...
    from HLTrigger.PhaseII.Muon.Customizers.customizerForPhase2MuonHLT_OIFromL2 import customizePhase2MuonHLTReconstruction
    process = customizePhase2MuonHLTReconstruction(process)

    from HLTrigger.PhaseII.Muon.Customizers.customizerForPhase2MuonHLT_OIFromL2 import customizePhase2MuonHLTIsolation
