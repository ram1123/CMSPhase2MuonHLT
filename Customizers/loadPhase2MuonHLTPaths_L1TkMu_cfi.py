...
"""
    ...
    from HLTrigger.PhaseII.Muon.Customizers.customizerForPhase2MuonHLT_L1TkMu import customizePhase2MuonHLTReconstruction
    process = customizePhase2MuonHLTReconstruction(process)

    from HLTrigger.PhaseII.Muon.Customizers.customizerForPhase2MuonHLT_L1TkMu import customizePhase2MuonHLTIsolation
