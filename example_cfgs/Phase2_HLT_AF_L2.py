...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('root://cms-xcache.rcac.purdue.edu//store/mc/Phase2Spring24DIGIRECOMiniAOD/DYToLL_M-50_TuneCP5_14TeV-pythia8/GEN-SIM-DIGI-RAW-MINIAOD/PU200_Trk1GeV_140X_mcRun4_realistic_v4-v1/2810000/47946cea-bd28-463f-ba64-0757207dd773.root'),
...
process.l1tGTProducer.GMTTkMuons = cms.InputTag("l1tTkMuonsGmt")
process.GTemulatorTask = cms.Task(process.l1tGTProducer, process.l1tGTAlgoBlockProducer)
process.GTemulation_step = cms.Path(cms.Sequence(process.GTemulatorTask))
